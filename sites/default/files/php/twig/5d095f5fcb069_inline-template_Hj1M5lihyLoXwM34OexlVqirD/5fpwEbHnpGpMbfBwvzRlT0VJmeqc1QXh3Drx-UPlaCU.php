...
/* {# inline_template_start #}<div class="row">
  <div class="col-sm-4"><br /><img src="{{ field_image }}"></div>
  <div class="col-sm-8"><h2>{{ title }}</h2><p>{{ field_bajada }}</p><p>{{ view_node }}</p><p><a href="{{ path }}" class="btn btn-large btn-primary pull-right">{{ field_texto_boton }}</a></p>
</div>
</div>  */
class __TwigTemplate_0f9adf784e919d37cedffb8484e36a1088d37af33f0a62076fc48fbce28e02ba extends Twig_Template
{
